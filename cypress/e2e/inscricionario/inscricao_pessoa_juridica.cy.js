...
describe("Teste HGTX CRECI - Inscriçáo Pessoa Jurídica", () => {
  beforeEach(() => {
    cy.loginCreci();
    cy.intercept("POST", "**/listar_apps_usuario/**", {
      ...
      body: {
        ...
        results: [
          {
            aplicativoID: 162,
            nome: "Consultar Censo - Pessoa Jurídica",
            favorito: false,
            icone:
  ...
  it.skip("deve ser capaz de visualizar a página de Inscrição - Pessoa Jurídica.", () => {
    cy.origin(
      "https://creci-procinscr.goutron.com.br/auth/requerimentos",
      () => {
  ...
  it.skip("deve ser capaz de visualizar um grid listando inscrições de Pessoa Jurídica.", () => {
    cy.origin(
      "https://creci-procinscr.goutron.com.br/auth/requerimentos",
      () => {
  ...
  it.skip("deve ser capaz de visualizar uma mensagem de erro na obtenção dos resultados do grid listando inscrições de Pessoa Jurídica.", () => {
    cy.origin(
      "https://creci-procinscr.goutron.com.br/auth/requerimentos",
      () => {
        cy.viewport(1920, 1080);
  ...
  it.skip("deve ser capaz abrir a modal de filtro e filtrar as informações por Status do requerimento.", () => {});
