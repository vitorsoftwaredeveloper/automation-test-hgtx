...
describe("Teste HGTX CRECI - Gerenciar Inscrições de Pessoa Jurídica", () => {
  beforeEach(() => {
    cy.loginCreci();
  ...
  it.skip("deve ser capaz de visualizar a página de Gerenciar Inscrições de Pessoa Jurídica.", () => {
    cy.origin(
      "https://creci-procinscr.goutron.com.br/auth/requerimentos",
      () => {
        cy.contains("h2", "Gerenciar Inscrições de Pessoa Jurídica").should(
          "be.visible"
        );
